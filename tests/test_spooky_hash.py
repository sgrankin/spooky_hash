...
def test_Hash32():
   ...
   eq_(0x478a7df4, hash(h))

   assert_not_equal(0x478a7df4, hash(copy))
   copy.update('world')
   eq_(0x478a7df4, hash(copy))
...
def test_Hash64():
   ...
   eq_(0x4f6bdd7d478a7df4, hash(h))

   assert_not_equal(0x4f6bdd7d478a7df4, hash(copy))
   copy.update('world')
   eq_(0x4f6bdd7d478a7df4, hash(copy))
...
def test_Hash128():
   ...
   copy.update('world')
   eq_('f47d8a477ddd6b4fbf3b493f8396830d', copy.hexdigest())
